...
public boolean ajouterChambres(int num_chambre, int type, String tel)
    {
        ...
        String addQuery = "INSERT INTO `rooms`(`num_chambre`, `type`, `tel`, `reserved`) VALUES (?,?,?,?)";
...
public boolean editChambre(int num_chambre,int type, String tel, String isReserved)
    {
        PreparedStatement st;
        String editQuery = "UPDATE `rooms` SET `type`=?,`tel`=?,`reserved`=? WHERE `num_chambre`=?";
   ...
   public boolean supprimerChambre(int roomnum_chambre)
    {
        PreparedStatement st;
        String deleteQuery = "DELETE FROM `rooms` WHERE `num_chambre`=?";
   ...
   public boolean mettreChambreReserved(int num_chambre, String isReserved)
    {
        PreparedStatement st;
        String editQuery = "UPDATE `rooms` SET `reserved`=? WHERE `num_chambre`=?";
    ...
    public String isChambreReserved(int num_chambre)
    {
        PreparedStatement st;
        ResultSet rs;
        String editQuery = "SELECT `reserved` FROM `rooms` WHERE `num_chambre`=?";
