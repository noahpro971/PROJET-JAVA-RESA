...
public class RESA {
   ...
   Connecto  my_connecto = new Connecto();
    ...
    public boolean ajouterReservation(int id_client, int num_chambre, String dateDebut, String dateFin)
    {
        PreparedStatement st;
        String addQuery = "INSERT INTO `reservations`(`client_id`, `num_chambre`, `date_debut`, `date_fin`) VALUES (?,?,?,?)";
    ...
    public boolean editReservation(int reservation_id,int id_client, int num_chambre, String dateDebut, String dateFin)
    {
        PreparedStatement st;
        String editQuery = "UPDATE `reservations` SET `client_id`=?,`num_chambre`=?,`date_debut`=?,`date_fin`=? WHERE `id`=?";
